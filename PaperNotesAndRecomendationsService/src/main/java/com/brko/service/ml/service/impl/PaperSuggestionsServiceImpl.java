...
import com.brko.service.ml.service.PaperSuggestionsService;
 ...
 */
@Service
public class PaperSuggestionsServiceImpl implements  PaperSuggestionsService {
    ...
    public List<PaperSummary> computeSuggestedPapers(User user) {

        List<Note> notesByUser = notesService.getNotesByUser(user);

        List<PaperSummary> allPaperSummaries = paperSummaryRepository.findAll();
